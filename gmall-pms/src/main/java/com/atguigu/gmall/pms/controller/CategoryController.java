...
public class CategoryController {
    ...
    @GetMapping("sub/cates/{pid}")
    public ResponseVo<List<CategoryEntity>> querySubCategoriesWithSubsByPid(@PathVariable("pid")Long pid){
        List<CategoryEntity> categoryEntities = this.categoryService.querySubCategoriesWithSubsByPid(pid);
    ...
    public ResponseVo<List<CategoryEntity>> queryCategoryEntity(@PathVariable("parentId") Long pid){
        List<CategoryEntity> categoryEntity =  categoryService.queryCategoryEntity(pid);
        return ResponseVo.ok(categoryEntity);
    }
