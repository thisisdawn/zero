...
public class AttrController {
    ...
    public ResponseVo<List<AttrEntity>> getAttrEntity(@PathVariable Long gid){
    ...
    public ResponseVo<List<AttrEntity>> getCategory(@PathVariable Long cid,
                                                    @RequestParam(required = false) Integer type,
                                                    @RequestParam(required = false) Integer searchType){
        List<AttrEntity> attrEntities =  attrService.getCategory(cid,type,searchType);
        return ResponseVo.ok(attrEntities);
    }
}
